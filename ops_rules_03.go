...
func opsRule0303() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0303",
		Name:           "forest-fire-watch-service control 0303",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0304() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0304",
		Name:           "forest-fire-watch-service control 0304",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       true,
	}
...
func opsRule0307() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0307",
		Name:           "forest-fire-watch-service control 0307",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0308() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0308",
		Name:           "forest-fire-watch-service control 0308",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       true,
	}
